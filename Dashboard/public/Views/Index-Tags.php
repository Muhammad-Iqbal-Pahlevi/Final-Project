...
$tags = $tags->paginate($startData, $limit); // Fungsi ini akan kita buat
                            ...
                            <table  class="w-full whitespace-no-wrap">
                                <thead>
                                    <tr
                                        ...
                                        <th class="px-4 py-3">Name Tags</th>
                                        ...
                                        <tr class="text-gray-700 dark:text-gray-400">
                                            ...
                                            <td class="px-4 py-3">
                                                <div class="flex items-center space-x-4 text-sm">
                                                    <a href="./Edit-Tags.php?id=<?= $tag['id_tag'] ?>"
                                                    ...
                                                    <a href="../Service/Delete-Tag.php?id=<?= $tag['id_tag'] ?>"
                                                        class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray"
                                                        aria-label="Delete">
                                                        <svg
                                                            class="w-5 h-5"
...
<script>
    ...
    keyword.on("keyup", () => {
        ...
        container.load("./Search-Tags.php?keyword=" + keyword.val())
    });
</script>
