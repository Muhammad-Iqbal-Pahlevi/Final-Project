...
if (isset($_POST['submit'])) {
    ...
    if ($result !== false) {
        echo "<script>alert('Kategori berhasil diubah {$result["name_category"]}');  window.location = 'index-category.php'; </script>;";
        die;
    }
}
            ...
            <main class="h-full pb-16 overflow-y-auto">
                <div class="container px-6 mx-auto grid">
                    ...
                    <form method="post" action=""
                        ...
                        <label for="name_category" class="block mt-4 text-sm">
                            ...
                            <div
                                ...
                                <input
                                    id="name_category" name="name_category" value="<?= $categories[0]['name_category']; ?>"
