...
// Instance untuk kategori, tag, dan pengguna
...
if ($blogId) {
    ...
    $blogData = $postModel->find($blogId);
    if (!$blogData) {
        die("Post not found");
    }
} else {
...
if (isset($_POST["submit"])) {
    ...
    // Update data
    $result = $postModel->update($blogId, $datas);

    if (is_string($result)) {
        echo "<script>alert('{$result}');</script>;";
    } else {
        echo "<script>alert('Blog berhasil diperbarui'); window.location = 'Index-Blog.php';</script>;";
    }
}
                    ...
                    <form method="post" action="" enctype="multipart/form-data"
                        ...
                        <label class="block text-sm" for="title">
                            ...
                            <input
                                ...
                                placeholder="Jane Doe" name="title" id="title" value="<?= $blogData[0]['title']; ?>" />
                        </label>
                        ...
                        <label class="block mt-4 text-sm" for="content">
                            ...
                            <textarea
                                ...
                                placeholder="Enter some long form content."><?= $blogData[0]['content']; ?></textarea>
                        </label>
